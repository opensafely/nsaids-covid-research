/*==============================================================================
DO FILE NAME:			S8-01_cr_create_exposure_outcome
...
* Open a log file
cap log close
log using $logdir\S8-01_cr_create_exposure_outcome, replace t
...
*Sensitivity analysis: NSAIDs exposure within 4 months before cohort entry
*Only include non-users who had NSAID prescription within 12 months before cohort entry
