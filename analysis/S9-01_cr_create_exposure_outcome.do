/*==============================================================================
DO FILE NAME:			S9-01_cr_create_exposure_outcome
...
* Open a log file
cap log close
log using $logdir\S9-01_cr_create_exposure_outcome, replace t
...
*Only include non-users who had NSAID prescription within 2 years before cohort entry
