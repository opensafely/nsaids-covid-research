...
**********************************************************************
import excel "H:\Desktop\COVID19\forest_plot_nsaid.xlsx", sheet("nsaid_population") cellrange(A1:F16) firstrow clear
...
graph export "H:\Desktop\COVID19\nsaid_forest_plot.svg", as(svg) replace
*********************************************************************

**********************************************************************
***Rheumatoid arthritis/ Osteoarthritis cohort
**********************************************************************
import excel "H:\Desktop\COVID19\forest_plot_nsaid.xlsx", sheet("oa_ra_population") cellrange(A1:F16) firstrow clear
...
nowarning nobox effect(Hazard Ratio) by(analysis) xlab (.25,.5,1,2,4)  ///
graphregion(color(white)) nosubgroup nooverall texts(100) astext(70)
graph export "H:\Desktop\COVID19\oa_ra_forest_plot.svg", as(svg) replace
*********************************************************************
