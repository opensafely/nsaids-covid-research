/*==============================================================================
DO FILE NAME:			S5_02a_cr_create_nsaid_population
...
cap log close
log using $logdir\S5_02a_cr_create_nsaid_population, replace t
...
noi di "DROP PATIENTS WHO EVER HAD ASPIRIN"
drop if aspirin_ever == 1
...
* EXCLUSION 3-6: PATIENTS WITH MI, STROKE, GI BLEED, ASPIRIN
